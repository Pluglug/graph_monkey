...
#                 for kmi in km.keymap_items:
#                     if (kmi.type == key and
#                         kmi.alt == modifiers['alt'] and
#                         kmi.ctrl == modifiers['ctrl'] and
#                         kmi.shift == modifiers['shift'] and
#                         kmi.active):
...
#         # コンテキストの検証
#         valid_contexts = [
#             'GRAPH_EDITOR', 'DOPESHEET_EDITOR', 'VIEW_3D', 'IMAGE_EDITOR',
#             'NODE_EDITOR', 'SEQUENCE_EDITOR', 'TEXT_EDITOR'
#         ]
