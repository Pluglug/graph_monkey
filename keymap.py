...
def register_keymaps():
    ...
    # Upward Extend
    kmi = km.keymap_items.new(
        "graph.monkey_vertically", type=dir_map["upward"], value='PRESS', alt=True, shift=True)
    kmi.properties.direction = "upward"
    ...
    # Downward Extend
    kmi = km.keymap_items.new(
        "graph.monkey_vertically", type=dir_map["downward"], value='PRESS', alt=True, shift=True)
    kmi.properties.direction = "downward"
    kmi.properties.extend = True
    ...
    # Forward Extend
    kmi = km.keymap_items.new(
        "graph.monkey_horizontally", type=dir_map["forward"], value='PRESS', alt=True, shift=True)
    kmi.properties.direction = "forward"
    kmi.properties.extend = True
    ...
    # Backward Extend
    kmi = km.keymap_items.new(
        "graph.monkey_horizontally", type=dir_map["backward"], value='PRESS', alt=True, shift=True)
    kmi.properties.direction = "backward"
    kmi.properties.extend = True
