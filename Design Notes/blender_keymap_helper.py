...
class BlenderKeymapHelper:
            ...
            "space_types": {
                "VIEW_3D": {
                    ...
                    "regions": {
                        "WINDOW": {
                            "keymaps": [
                                {"name": "Paint Face Mask (Weight, Vertex, Texture)", "poll": "face_mask_mode_poll", "priority": 1},
                                {"name": "Paint Vertex Selection (Weight, Vertex)", "poll": "vertex_selection_mode_poll", "priority": 2},
                                {"name": "Paint Curve", "poll": "paint_curve_poll", "priority": 3},
                                {"name": "Weight Paint", "poll": "weight_paint_mode_poll", "priority": 4},
                                {"name": "Vertex Paint", "poll": "vertex_paint_mode_poll", "priority": 5},
                                {"name": "Pose", "poll": "pose_mode_poll", "priority": 6},
                                {"name": "Object Mode", "poll": "object_mode_poll", "priority": 7},
                                {"name": "Curve", "poll": "curve_edit_poll", "priority": 8},
                                {"name": "Curves", "poll": "curves_edit_poll", "priority": 9},
                                {"name": "Image Paint", "poll": "image_paint_mode_poll", "priority": 10},
                                {"name": "Sculpt", "poll": "sculpt_mode_poll", "priority": 11},
                                {"name": "Mesh", "poll": "ED_operator_editmesh", "priority": 12},
                                {"name": "Armature", "poll": "armature_edit_poll", "priority": 13},
                                {"name": "Metaball", "poll": "metaball_edit_poll", "priority": 14},
                                {"name": "Lattice", "poll": "lattice_edit_poll", "priority": 15},
                                {"name": "Particle", "poll": "particle_edit_poll", "priority": 16},
                                {"name": "Point Cloud", "poll": "pointcloud_edit_poll", "priority": 17},
                                {"name": "Sculpt Curves", "poll": "sculpt_curves_poll", "priority": 18},
                                {"name": "Grease Pencil Selection", "poll": "grease_pencil_selection_poll", "priority": 19},
                                {"name": "Grease Pencil Edit Mode", "poll": "grease_pencil_edit_poll", "priority": 20},
                                {"name": "Grease Pencil Paint Mode", "poll": "grease_pencil_paint_poll", "priority": 21},
                                {"name": "Grease Pencil Sculpt Mode", "poll": "grease_pencil_sculpt_poll", "priority": 22},
                                {"name": "Grease Pencil Weight Paint", "poll": "grease_pencil_weight_poll", "priority": 23},
                                {"name": "Grease Pencil Vertex Paint", "poll": "grease_pencil_vertex_poll", "priority": 24},
                                {"name": "Font", "poll": "font_edit_poll", "priority": 27},
                                {"name": "Object Non-modal", "poll": None, "priority": 28},
                                {"name": "Frames", "poll": None, "priority": 29},
                                {"name": "3D View Generic", "poll": None, "priority": 30},
                ...
                "IMAGE": {
                    ...
                    "regions": {
                        "WINDOW": {
                            "keymaps": [
                                {"name": "Mask Editing", "poll": "mask_mode_poll", "priority": 1},
                                {"name": "Curve", "poll": "curve_edit_poll", "priority": 2},
                                {"name": "Paint Curve", "poll": "paint_curve_poll", "priority": 3},
                                {"name": "Image Paint", "poll": "image_paint_mode_poll", "priority": 4},
                                {"name": "UV Editor", "poll": "uv_edit_poll", "priority": 5},
    ...
    def simulate_poll_function(self, poll_name: str, context) -> bool:
        ...
        poll_logic = {
            ...
            "uv_edit_poll": lambda: current_mode == 'EDIT_MESH' and hasattr(context, 'space_data') and context.space_data.type == 'IMAGE_EDITOR',
            "face_mask_mode_poll": lambda: current_mode in ['PAINT_WEIGHT', 'PAINT_VERTEX', 'PAINT_TEXTURE'] and active_object and active_object.data.use_paint_mask,
            "vertex_selection_mode_poll": lambda: current_mode in ['PAINT_WEIGHT', 'PAINT_VERTEX'] and active_object and active_object.data.use_paint_mask_vertex
        }
